 ...
 * @author apiiit-rkv
 */
@WebServlet(urlPatterns = {"/printCustomerDetails"})
public class printCustomerDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                name=(String)session.getAttribute("did");
               ...
               // st=conn.createStatement();
                ...
                ps=conn.prepareStatement("select * from customerDetails where d_id=?;");
                ps.setString(1,name);
                rs=ps.executeQuery(); 
                rsmd=rs.getMetaData();
...
//                out.println(rsmd.getColumnName(5)+"</b></td></tr> ");
                ...
                while(rs.next()){
                    ...
                    //out.println(rs.getString("username")+"</td><td>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(printCustomerDetails.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(printCustomerDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
